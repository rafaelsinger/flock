...
export const LandingPage = () => {
  // TODO: (maybe) change handle sign in here using session
  const handleSignIn = () => {
        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          ...
          <div className="flex flex-col space-y-8">
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight text-[#333333] leading-[1.1]">
              Discover where BC grads{" "}
              <span className="text-[#F28B82]">flock</span> after graduation.
            </h1>

            <p className="text-xl leading-relaxed text-[#333333]/70">
              Find where your classmates are landing after graduation. Browse by
              city, company, or industry.
            </p>
